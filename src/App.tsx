...
import QCParametersPage from "./pages/purchase/QCParametersPage";
...
import CashFlowForecastPage from "./pages/accounting/CashFlowForecastPage";
...
import AccountingExpensesAnalysisPage from "./pages/accounting/ExpensesAnalysisPage";
...
import OnlineLiveStatusPage from "./pages/online-sales/OnlineLiveStatusPage";
      ...
      <AuthProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/online-sales/live-status" element={<ProtectedRoute><OnlineLiveStatusPage /></ProtectedRoute>} />
            ...
            <Route path="/accounting/cash-flow-forecast" element={<ProtectedRoute><CashFlowForecastPage /></ProtectedRoute>} />
