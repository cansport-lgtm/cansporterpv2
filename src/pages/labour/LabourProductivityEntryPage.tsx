...
const LabourProductivityEntryPage = () => {
  ...
  const canImportExport = isSuperAdmin || hasRole("manager") || hasRole("labour_productivity_approver");
  ...
  const handleEmployeePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.error(`Photo upload failed: ${error.message || "unknown error"}. The photo will NOT be saved with this employee.`, { duration: 8000 });
    } finally {
