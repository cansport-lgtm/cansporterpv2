...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Held Stock Inventory", href: "/planning/held-stock" },
  ...
  // chevron expands the full submenu.
  {
    ...
    children: [
      ...
      { title: "Raw Material Inventory", href: "/accounting/rm-inventory", allowedRoles: ["accounting_manager", "super_admin"] },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Grade Stock Ledger", href: "/production/grade-ledger" },
      { title: "Regrades", href: "/production/regrades" },
      { title: "Grade Ledger Setup", href: "/production/grade-ledger/setup", superAdminOnly: true },
  ...
  */
  ...
  },
  {
    ...
    children: [
      ...
      { title: "MPH Analysis", href: "/labour/mph-analysis" },
